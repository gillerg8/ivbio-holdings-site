		...
		<Layout>
			...
			<Content>
				<SlideObject slideDirection='down'>
					...
					<SubHeader>Blending tradition and innovation</SubHeader>
					<Quote>
						"Every decision that I make personally and professionally begins
						with, and ends with, a genuine and passionate love for people."
					</Quote>
					<Card
						imageSrc={MartyImage}
